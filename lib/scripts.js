...
const fetchEvents = async () => {
  const url = `${corsAnywhereUrl}https://calendar-be.herokuapp.com/api/v1/events/`;
...
const fetchEventTasks = async (id) => {
  const url = `${corsAnywhereUrl}https://calendar-be.herokuapp.com/api/v1/events/${id}/tasks`;
  const response = await fetch(url);
  const results = await response.json();
  return results;
};
...
const saveEvent = (event) => {
  ...
  let newEvent = { title, date, time, category }
...
const addEventToDB = async (newEvent) => {
  ...
  const url = `${corsAnywhereUrl}${corsAnywhereUrl}https://calendar-be.herokuapp.com/api/v1/events/`;
  const response = await fetch(url, {
    method: 'POST',
    body: JSON.stringify({
      newEvent
...
const deleteEventFromDatabase = async (eventId) => {
  console.log(eventId)
  const url = `${corsAnywhereUrl}https://calendar-be.herokuapp.com/api/v1/events/${eventId}`;
  const response = await fetch(url, {
    method: 'DELETE'
  });
  const results = await response.json();
...
const deleteTaskFromDatabase = async (eventId, taskId) => {
  const url = `${corsAnywhereUrl}https://calendar-be.herokuapp.com/api/v1/events/${eventId}/tasks/${taskId}`;
  const response = await fetch(url, {
    method: 'DELETE'
  });
  const results = await response.json();
...
const handleDeleteTask = async (event) => {
  ...
  // deleteTaskFromDatabase(eventId, taskId);
